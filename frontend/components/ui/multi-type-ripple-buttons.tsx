...
const RippleButton: React.FC<RippleButtonProps> = ({
    ...
    // Default variant
    const baseClasses = "relative flex items-center justify-center gap-2 border-none overflow-hidden isolate transition-all duration-200 cursor-pointer px-4 py-2 bg-blue-600 hover:opacity-90 text-white rounded-lg text-sm";
